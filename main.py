...
API_BASE_URL = 'https://bio.ffutils.tech/api/update_bio'OWNER_USERNAME = '@Adityasingh1980' # add your telegram username here. example: '@itzpaglu'
REQUIRED_CHANNEL = '@addy_prime_11' # add your required channel username here. example: '@paglu_dev'. if you dont have any channel then leave it blank.
