...
OWNER_USERNAME = ' '
# add your telegram username here. example: '@itzpaglu'
REQUIRED_CHANNEL =' ' 
# add your required channel username here. example: '@paglu_dev'. if you dont have any channel then leave it blank.
